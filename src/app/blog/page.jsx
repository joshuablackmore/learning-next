...
//         <div className='flex col-span-2 flex-col items-center justify-center text-center border rounded-md border-slate-400 shadow-lg shadow-slate-600 p-9 overflow-hidden' key={post.id}>
