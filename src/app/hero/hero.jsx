...
const Hero = () => {
  ...
  return (
    <div className='flex items-center flex-col h-screen bg-light1 box-border landscape:flex-row '>

        <div className='min-h-[395px] h-[50%] w-[100%] md:h-[60%] lg:h-[90%] xl:h-[100%] max-w-[1180px] flex items-center landscape:border '>
            {imageLoaded && (
            <motion.div
            ...
            <div className='h-[50%] w-[100%] flex items-center landscape:overflow-scroll landscape:h-full'>
                {imageLoaded && (
                <motion.div
                initial={{ opacity: 0}}
                animate={{ opacity: 1}}
